...
public:
    ...
    PrivateKey(const char * wifArr, const Network * net);
#endif
    ~PrivateKey();
    ...
    int fromWIF(const char * wifArr, size_t wifSize, const Network * net);
...
public:
    ...
    operator bool() const{ return (scriptLen > 0); };
...
public:
    ...
    operator bool() const{ return (numElements > 0); };

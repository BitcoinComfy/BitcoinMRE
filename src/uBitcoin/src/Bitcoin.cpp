...
int PrivateKey::fromWIF(const char * wifArr, size_t wifSize, const Network * net){
    uint8_t arr[40] = { 0 };
...
PrivateKey::PrivateKey(const char * wifArr, const Network * net){
    fromWIF(wifArr, strlen(wifArr), net);
}
